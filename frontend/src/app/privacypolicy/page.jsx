            ...
            <div className="flex flex-col min-h-screen">
                ...
                <div className="hero">
                    <div className="flex-1 padding-x">
                        ...
                        <div className="mt-14">
                            <p className="mb-2 text-gray-700">Last updated: August 11, 2024</p>
                            ...
                            <ul className="list-disc list-inside mb-4">
                                ...
                                <li><span className="font-semibold">Company</span> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to featherai: AI Email Generator.</li>
                                ...
                                <li><span className="font-semibold">Usage Data</span> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
                                <li><span className="font-semibold">Website</span> refers to featherai: AI Email Generator, accessible from <Link href="https://featherai.onrender.com/" className="text-blue-500 hover:underline">https://featherai.onrender.com/</Link>.</li>
                            ...
                            <ul className="list-disc list-inside mb-4">
                                <li><span className="font-semibold">Type:</span> Session Cookies</li>
                                <li><span className="font-semibold">Administered by:</span> Us</li>
                            ...
                            <ul className="list-disc list-inside mb-4">
                                <li><span className="font-semibold">Type:</span> Persistent Cookies</li>
                                <li><span className="font-semibold">Administered by:</span> Us</li>
                                <li><span className="font-semibold">Purpose:</span> These Cookies identify if users have accepted the use of cookies on the Website.</li>
                            </ul>
                            ...
                            <p className="mb-4">
                                For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or Cookies Notice.
                            </p>
                            ...
                            <ul className="list-disc list-inside mb-4">
                                ...
                                <li><span className="font-semibold">To provide You with news, special offers, and general information:</span> About other goods, services, and events which We offer that are similar to those that You have already purchased or enquired about unless You have opted not to receive such information.</li>
                                <li><span className="font-semibold">To manage Your requests:</span> To attend to and manage Your requests to Us.</li>
                            ...
                            <ul className="list-disc list-inside mb-4">
                                <li>By email: <Link href="mailto:featheraiwriter@gmail.com" className="text-blue-600">[email protected]</Link></li>
                                <li>By visiting this page on our website: <Link href="https://featherai.onrender.com/" className="text-blue-600">https://featherai.onrender.com/</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
